...
if not options.useData :
    ...
    process.source = cms.Source("PoolSource",
                            fileNames  =
                                cms.untracked.vstring("file:///shome/gregor/data/ttbar.root"),
...
##     #icorr.rho = cms.InputTag("fixedGridRhoFastjetAll", "rho")
...
# Analyzer (write PFCandidates into flat NTuple)

process.dumpBJets = cms.EDAnalyzer('AnalyzerDumpBJets')
...
process.Top0 = cms.EDAnalyzer('AnalyzerHTT',
                                postfix             = cms.untracked.string('m30'),
                                prefix              = cms.untracked.string('pf'),
                                use_gen_input       = cms.untracked.bool(False),
                                n_filter_top        = cms.untracked.int32(5),
                                mt_window_min       = cms.untracked.double(0.),
                                mt_window_max       = cms.untracked.double(20000.),
                                m_cut               = cms.untracked.double(30.),
...
process.p0 *= process.genParticlesForJets

process.p0 *= process.Top0
